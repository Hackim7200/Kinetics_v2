...
// import 'package:mobile_frontend/feature/exercise_analytics/widgets/weight_and_reps_table.dart';
// import 'package:mobile_frontend/feature/exercise_analytics/widgets/set_entry_table.dart';
...
//   final GlobalKey<SetEntryTableState> _sessionTableKey =
//       GlobalKey<SetEntryTableState>();
...
//         .map((w) => w.totalTrainingLoad ?? totalTrainingLoadForSets(w.sets))
//         .toList();
...
//     try {
//       final inserted = await _sessionSetsService
//           .insertDummyStrengthWorkoutForYesterday(
//             routineExerciseId: routineExerciseId,
//             setCount: _maxSets,
//             baseWeightKg: widget.exercise.weight > 0
...
//           const SnackBar(
//             content: Text(
//               'Yesterday already has a workout log for this exercise.',
//             ),
//           ),
//         );
//         return;
...
//         context,
//       ).showSnackBar(SnackBar(content: Text('Could not add test data: $e')));
//     }
//   }
...
//         ),
//         const SizedBox(height: 24),
//         WeightsAndRepsTable(sessions: _historySessions),
//         if (kDebugMode) ...[
//           const SizedBox(height: 24),
//           OutlinedButton.icon(
