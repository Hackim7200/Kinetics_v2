...
/// Column titles: SET | WEIGHT | REPS.
class SetEntryTableHeader extends StatelessWidget {
  const SetEntryTableHeader({super.key});
      ...
      child: IntrinsicHeight(
        child: Row(
          ...
          children: [
            ...
            Expanded(
              child: Center(
                child: Text('REPS', style: headerStyle, textAlign: TextAlign.center),
              ),
            ),
          ],
        ),
