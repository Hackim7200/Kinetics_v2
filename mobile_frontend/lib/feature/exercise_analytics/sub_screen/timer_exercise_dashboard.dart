...
// import 'package:mobile_frontend/feature/exercise_analytics/widgets/technique_notes/technique_notes_card.dart';
...
// import 'package:mobile_frontend/feature/exercise_analytics/widgets/history_table/workout_detail_timer_history_table.dart';
...
//     final totals = _historySessions.map((w) => w.sessionTotal).toList();
...
//         _sessionTotalSecondsSeries =
//             graphSlice.map((w) => w.sessionTotal).toList();
...
//           percentChangeDisplay: _sessionTotalChangeDisplay,
